                ...
                state("question") {
                    ...
                    action {
                        context.session["question"] =
                            (context.session["randomQuestions"] as MutableList<*>).removeLast() as Question
                        ...
                        val questionMessage: String =
                            "Question " + (context.session["questionNumber"] as Int) + " of 20:" + "\n\n" +
                    ...
                    state("1") {
                        ...
                        action {
                            if ((context.session["options"] as MutableList<*>)[0] == (context.session["question"] as Question).correctAnswer) {
                                ...
                                (context.session["wrongAnswers"] as MutableMap<Question, String>)[(context.session["question"] as Question)] =
                                    (context.session["options"] as MutableList<*>)[0] as String
                            }
                            if ((context.session["randomQuestions"] as MutableList<*>).size == 0) {
                    ...
                    state("2") {
                        ...
                        action {
                            if ((context.session["options"] as MutableList<*>)[1] == (context.session["question"] as Question).correctAnswer) {
                                ...
                                (context.session["wrongAnswers"] as MutableMap<Question, String>)[(context.session["question"] as Question)] =
                                    (context.session["options"] as MutableList<*>)[1] as String
                            }
                            if ((context.session["randomQuestions"] as MutableList<*>).size == 0) {
                                reactions.go("/main/quiz/score")
                            } else {
                    ...
                    state("3") {
                        ...
                        action {
                            if ((context.session["options"] as MutableList<*>)[2] == (context.session["question"] as Question).correctAnswer) {
                                ...
                                (context.session["wrongAnswers"] as MutableMap<Question, String>)[(context.session["question"] as Question)] =
                                    (context.session["options"] as MutableList<*>)[2] as String
                            }
                            if ((context.session["randomQuestions"] as MutableList<*>).size == 0) {
                                reactions.go("/main/quiz/score")
                            } else {
                    ...
                    state("4") {
                        ...
                        action {
                            if ((context.session["options"] as MutableList<*>)[3] == (context.session["question"] as Question).correctAnswer) {
                                ...
                                (context.session["wrongAnswers"] as MutableMap<Question, String>)[(context.session["question"] as Question)] =
                                    (context.session["options"] as MutableList<*>)[3] as String
                            }
                            if ((context.session["randomQuestions"] as MutableList<*>).size == 0) {
                                reactions.go("/main/quiz/score")
                            } else {
